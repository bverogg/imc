...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final XLibraryAccessors laccForXLibraryAccessors = new XLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>x</b>
     */
    public XLibraryAccessors getX() {
        return laccForXLibraryAccessors;
    }
    ...
    public static class XLibraryAccessors extends SubDependencyFactory {
        private final XX4LibraryAccessors laccForXX4LibraryAccessors = new XX4LibraryAccessors(owner);

        public XLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>x.x4</b>
         */
        public XX4LibraryAccessors getX4() {
            return laccForXX4LibraryAccessors;
        }

    }

    public static class XX4LibraryAccessors extends SubDependencyFactory {

        public XX4LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>x</b> with <b>mockito.core:5.14.2</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getX() {
            return create("x.x4.x");
        }
